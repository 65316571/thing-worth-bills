...
const seedItems = [
  ["小米2万mAh充电宝", 159, "2023-02-15", null, "电子产品", null, "active", "出行必备，很耐用"],
  ["飞智黑武士3 Pro", 264.38, "2023-01-08", null, "游戏设备", null, "active", "手游神器"],
  ["黑铁牛键盘", 281.92, "2023-01-01", null, "电子产品", null, "active", "段落感很棒"],
  ["索尼WH-1000XM4", 1899, "2022-08-20", null, "耳机", null, "active", "降噪效果一流"],
  ["旧款机械键盘", 399, "2021-03-10", "2023-01-01", "电子产品", null, "inactive", "已换掉"],
];
  ...
  if (withSeed) {
    ...
    if (itemsCountResult.rows[0].count === 0) {
      for (const item of seedItems) {
        await query(
          `
            INSERT INTO items (name, price, buy_date, stop_date, category, icon, status, note)
